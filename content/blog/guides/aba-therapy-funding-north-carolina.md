**URL (keep):** `/post/is-aba-therapy-covered-by-insurance-north-carolina`
**SEO title (59 chars):** Is ABA Therapy Covered by Insurance in North Carolina?
**Meta description (154 chars):** North Carolina's autism mandate, NC Medicaid, Early Intervention and school services, with the 120-day appeal deadline. Every figure sourced and dated.
**Category:** Living with Autism | Access, Insurance & Resources
**Data source:** `data/funding/north-carolina.json` (37 facts, gate green 2026-08-11)
**Replaces:** the existing body at this URL. Absorb, not redirect. See `OVERLAP-DECISION-north-carolina.md`.
...
Almost none of what is on this page is written down anywhere a parent would think to look. It came out of the session law, a Medicaid clinical coverage policy, the Department of Insurance, and the state's early intervention and special education rules, read line by line and dated so you can see how current it is. That is the same work we do with families every week, because the funding conversation is not an afterthought for us. It is usually the first one. Mastermind Behavior is a BCBA-owned provider delivering [in-home ABA therapy](https://www.mastermindbehavior.com/in-home-aba-therapy) across [North Carolina](https://www.mastermindbehavior.com/aba-therapy-in-north-carolina), New Jersey and Georgia, and we will help you work out which of the systems above applies to your child, what your plan is actually obliged to cover, and whether a denial is worth appealing. If we are not the right fit for your family, we will tell you that as well. You can [talk it through with us](https://www.mastermindbehavior.com/contact) before you commit to anything.

## Sources

Every figure on this page was checked against these documents on 11 August 2026.

1. N.C. Session Law 2015-271, An Act to Provide Coverage for the Treatment of Autism Spectrum Disorder.
2. N.C.G.S. 58-3-192, Coverage for autism spectrum disorder.
3. NC Medicaid. Clinical Coverage Policy No. 8F, Research-Based Behavioral Health Treatment for Autism Spectrum Disorder. Amended 1 August 2026.
4. NC Medicaid. Research Based Behavioral Health Treatment for Autism Spectrum Disorder, bulletin on CMS approval for beneficiaries over 21, effective 1 July 2021.
5. NC Department of Insurance, Smart NC. Request an External Review.
6. NCDHHS. About the North Carolina Infant-Toddler Program.
7. NCDHHS. Early Childhood Transitions in North Carolina: A Parent's Guide.
8. NC Department of Public Instruction. Policies Governing Services for Children with Disabilities, amended March 2021.
9. 29 U.S.C. 1144(b)(2). ERISA saving clause and deemer clause.
10. US Department of Labor, Employee Benefits Security Administration. Filing a Claim for Your Health Benefits.

---

## Build notes

Absorbs the existing post at this URL rather than redirecting it. Kept from
the original: the three-bucket framing, the note that most first-year
programs sit inside the annual maximum, the observation that NC licenses
behavior analysts and the resulting single case agreement advice.

Fixed from the original: it named NCDHHS as overseeing compliance and told
families near the cap to go there, which would send a parent to the wrong
agency; it had an appeals section with no deadline in it; it omitted the
statute's order requirement; and it presented $40,000 as the live figure.

The State Health Plan section deliberately declines to characterize terms
we have not verified. Better a short honest section than a confident wrong
one.
